...
> This page contains information about the CLI support of Gobierno Autonomo Municipal De Laja.

### Introduction

Starting from v1.4.0 Gobierno Autonomo Municipal De Laja has introduced CLI support, providing a set of useful utilities to use with your installation. 
...
This command will perform a CLI installation of Gobierno Autonomo Municipal De Laja. 
