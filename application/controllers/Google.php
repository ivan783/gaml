...
class Google extends EA_Controller {
    ...
    /**
     * Complete synchronization of appointments between Google Calendar and Gobierno Autonomo Municipal De Laja.
     *
    ...
    public static function sync($provider_id = NULL)
    {
        try
        {
            ...
            foreach ($appointments as $appointment)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        {
                            throw new Exception('Event is cancelled, remove the record from Gobierno Autonomo Municipal De Laja.');
                        }

                        // If Google Calendar event is different from Gobierno Autonomo Municipal De Laja appointment then update
                        // Gobierno Autonomo Municipal De Laja record.
                        $is_different = FALSE;
            ...
            // Add Google Calendar events that do not exist in Gobierno Autonomo Municipal De Laja.
            ...
            foreach ($google_events->getItems() as $google_event)
            {
                ...
                // Record doesn't exist in the Gobierno Autonomo Municipal De Laja, so add the event now.
                $appointment = [
     ...
     * documentation of OAuth), every Gobierno Autonomo Municipal De Laja installation should use its own calendar api key. So in every
     * api console account, the "http://path-to-Gobierno Autonomo Municipal De Laja/google/oauth_callback" should be included in an allowed redirect URL.
     */
