 ...
 * Class Console
 *
 * CLI commands of Gobierno Autonomo Municipal De Laja, can only be executed from a terminal and not with a direct request.
 */
class Console extends EA_Controller {
     ...
     *
     * Use this method to install Gobierno Autonomo Municipal De Laja directly from the terminal.
     *
     * Usage:
     *
     ...
     *
     * Use this method to backup your Gobierno Autonomo Municipal De Laja data.
     *
     * Usage:
     *
    ...
    public function backup()
    {
        ...
        $filename = 'gamlaja-backup-' . date('Y-m-d-His') . '.gz';
     ...
     *
     * Use this method in a cronjob to automatically sync events between Gobierno Autonomo Municipal De Laja and Google Calendar.
     *
     * Notice:
     *
    ...
    public function help()
    {
        $help = [
            '',
            'Gobierno Autonomo Municipal De Laja ' . config('version'),
            '',
            'Usage:',
            '',
