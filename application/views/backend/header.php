...
<head>
    ...
    <title><?= isset($page_title) ? $page_title : lang('backend_section') ?> | Gobierno Autonomo Municipal De Laja</title>
...
<nav id="header" class="navbar navbar-expand-md navbar-dark">
    <div id="header-logo" class="navbar-brand">
        ...
        <h6>Gobierno Autonomo Municipal De Laja</h6>
        <small>Laja - La Paz</small>
    </div>
