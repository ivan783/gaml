...
<head>
    ...
    <title>Update | Gobierno Autonomo Municipal De Laja</title>
...
<header>
    <div class="container">
        <h1 class="page-title">Gobierno Autonomo Municipal De Laja Update</h1>
    </div>
</header>
        ...
        <div class="col">
            <?php if ($success): ?>
                <div class="jumbotron">
                    ...
                    <hr class="my-4">
                    <p>
                        You can now use the latest Gobierno Autonomo Municipal De Laja version.
                    </p>
