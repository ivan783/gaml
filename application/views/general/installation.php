...
<head>
    ...
    <title>Installation | Gobierno Autonomo Municipal De Laja</title>
...
<header>
    <div class="container">
        <h1 class="page-title">Gobierno Autonomo Municipal De Laja Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the Gobierno Autonomo Municipal De Laja installation page.</h3>
        <p>
            This page will help you set the main settings of your Gobierno Autonomo Municipal De Laja installation.
            ...
            url to connect to the backend section of Gobierno Autonomo Municipal De Laja.

            If you face any problems during the usage of Gobierno Autonomo Municipal De Laja you can always check the
            <a href="http://gamlaja.org/docs.html">Documentation</a>
            ...
            <a href="https://github.com/alextselegidis/gamlaja/issues">GitHub Issues</a>
    ...
    <p>
    <h3>License</h3>
    Gobierno Autonomo Municipal De Laja is licensed under the <span class="badge badge-default">GPL-3.0 license</span>.
    By using the code of Gobierno Autonomo Municipal De Laja in any way <br> you agree with the terms described in the
    following url:
    ...
    <button type="button" id="install" class="btn btn-success btn-large">
        ...
        Install Gobierno Autonomo Municipal De Laja
    </button>
</div>

<footer>
    Visitanos <a href="https://laja.org">Gobierno Autonomo Municipal De Laja</a>
</footer>
