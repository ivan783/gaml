...
$lang['about_app'] = 'Über Gobierno Autonomo Municipal De Laja';
...
$lang['about_app_info'] = 'Gobierno Autonomo Municipal De Laja ist eine extrem anpassungsfähige Internet-Applikation die es Ihren Kunden ermöglicht, einen Termin mit Ihnen über des Internet zu schließen. Darüberhinaus gibt es Ihnen die Möglichkeit Ihre Daten mit dem Google Kalender zu synchronisieren, so dass Sie diese mit anderen Dienstleistungsprogrammen nutzen können.';
$lang['current_version'] = 'Laufende Version';
$lang['support'] = 'Unterstützung';
$lang['about_app_support'] = 'Falls Sie irgendein Problem bei der Nutzung von Gobierno Autonomo Municipal De Laja haben sollten können Sie die offizielle Google Gruppe nach Lösungen durchsuchen. Sie können auch ein neues Thema in Google Code beginnen, damit Sie die Findung von Lösungen unterstützen. ';
...
$lang['about_app_license'] = 'Easy!Appointment ist lizensiert under der GPLv3-Lizenz. Bei Benutzung des Codes für Gobierno Autonomo Municipal De Laja auf irgendeine Weise stimmen Sie mit den Nutzungsbedingungen zu wie sie in folgender url aufgeführt sind:';
...
$lang['ea_update_success'] = 'Gobierno Autonomo Municipal De Laja wurde erfolgreich aktualisiert.';
...
$lang['api_token_hint'] = 'Setze einen geheimen Token um die tokenbasierte Authentifizierung für die Gobierno Autonomo Municipal De Laja API zu aktivieren.';
