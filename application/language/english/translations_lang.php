...
$lang['about_app'] = 'About Gobierno Autonomo Municipal De Laja';
...
$lang['about_app_info'] = 'Gobierno Autonomo Municipal De Laja is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using Gobierno Autonomo Municipal De Laja you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'Gobierno Autonomo Municipal De Laja is licensed under the GPLv3 license. By using the code of Gobierno Autonomo Municipal De Laja in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'Gobierno Autonomo Municipal De Laja has been successfully updated.';
