...
$lang['about_app'] = 'O aplikaci Gobierno Autonomo Municipal De Laja';
...
$lang['about_app_info'] = 'Gobierno Autonomo Municipal De Laja je vysoce přizpůsobitelná webová aplikace, která vašim zákazníkům umožňuje rezervovat si s vámi schůzky prostřednictvím webu. Navíc poskytuje možnost synchronizovat vaše data s Kalendářem Google, takže je můžete využívat v rámci dalších služeb.';
$lang['current_version'] = 'Aktuální verze';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Pokud při používání Gobierno Autonomo Municipal De Laja narazíte na jakékoli problémy můžete odpovědi hledat v oficiální skupině Google. Také můžete založit nový incident na stránce Google Code za účelem podpory dalšího vývoje.';
...
$lang['about_app_license'] = 'Gobierno Autonomo Municipal De Laja je licencováno pod licencí GPLv3. Používáním kódu Gobierno Autonomo Municipal De Laja v jakékoli formě souhlasíte s podmínkami popsanými v dokumentu na následující adrese:';
...
$lang['ea_update_success'] = 'Aplikace Gobierno Autonomo Municipal De Laja byla úspěšně aktualizována.';
