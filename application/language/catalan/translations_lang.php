...
$lang['about_app'] = 'Quant a Gobierno Autonomo Municipal De Laja';
...
$lang['about_app_info'] = 'Gobierno Autonomo Municipal De Laja és una aplicació web molt ajustable que permet als vostres clients reservar cites amb vosaltres a través del web. A més, us permet sincronitzar amb Google Calendar de manera que ho podeu usar amb altres serveis.';
$lang['current_version'] = 'Versió actual';
$lang['support'] = 'Suport';
$lang['about_app_support'] = 'Si trobeu qualsevol problema fent servir Gobierno Autonomo Municipal De Laja, podeu consultar el Google Group per a trobar respostes. També podeu crear noves incidències a la pàgina de Google Code per ajudar al desenvolupament.';
...
$lang['about_app_license'] = 'Gobierno Autonomo Municipal De Laja es distribueix amb una llicència GPLv3. Usant el codi d\'Gobierno Autonomo Municipal De Laja de qualsevol manera, esteu consentint els termes descrits en la següent URL:';
...
$lang['ea_update_success'] = 'Gobierno Autonomo Municipal De Laja s\'ha actualitzat correctament.';
