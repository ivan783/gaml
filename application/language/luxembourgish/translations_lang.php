...
$lang['about_app'] = 'Iwwert Gobierno Autonomo Municipal De Laja';
...
$lang['about_app_info'] = 'Gobierno Autonomo Municipal De Laja ass eng extrem upassungsfäeg Internet-Applikatioun déi et äre Clienten erméiglecht, een Termäin bei Iech iwwert Internet ze huelen. Doriwwer eraus gëtt en Iech d\'Méiglechkeet Är Donnéeën mam Google Kalenner ze synchroniséieren, sou dass Der des mat anere Programmer notze kënnt.';
$lang['current_version'] = 'Aktuell Versioun';
$lang['support'] = 'Ënnerstëtzung';
$lang['about_app_support'] = 'Falls Dir iergendeen Problem beim Benotze vun Gobierno Autonomo Municipal De Laja hätt, kënnt der déi offiziell Google Grupp no Léisungen duerchsichen. Dir kënnt och een neit Thema am Google Code ufänke fir bei der Sich no Léisungen ze hëllefen. ';
...
$lang['about_app_license'] = 'Easy!Appointment ass ënnert der GPLv3-Lizenz lizenséiert. Duerch d\'Benotze vum Code vun Gobierno Autonomo Municipal De Laja op iergendeng Aart a Weis stëmmt Der den Lizenzbedingungen, wéi se ënnert folgender URL opgefouert sinn, zou:';
...
$lang['ea_update_success'] = 'Gobierno Autonomo Municipal De Laja gouf erfollegräich aktualiséiert.';
