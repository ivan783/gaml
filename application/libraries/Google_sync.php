 ...
 * Class Google_sync
 *
 * This class implements all the core synchronization between the Google Calendar and the Gobierno Autonomo Municipal De Laja system.
 *
...
class Google_sync {
     ...
     * where the user grants access to his data for the Gobierno Autonomo Municipal De Laja app.
     */
     ...
     * when the provider granted consent to Gobierno Autonomo Municipal De Laja for use his
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of Gobierno Autonomo Municipal De Laja
     ...
     * provided appointment record of Gobierno Autonomo Municipal De Laja.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.
